<x-layouts.app title="Add New Case" header="Add New Case">
    <!-- Breadcrumb -->
    <nav class="mb-6">
        <ol class="flex items-center space-x-2 text-sm">
            <li><a href="{{ route('cases.index') }}" class="text-primary-600 hover:text-primary-700">Cases</a></li>
            <li><i class="fas fa-chevron-right text-gray-400 text-xs"></i></li>
            <li class="text-gray-500">Add New Case</li>
        </ol>
    </nav>

    <form method="POST" action="{{ route('cases.store') }}" class="space-y-8">
        @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div>
                    ...
                    <input 
                        ...
                        id="date_filed" 
                        name="date_filed" 
                        value="{{ old('date_filed', date('Y-m-d')) }}"
                        required
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <!-- Complainant -->
                <div>
                    <label for="complainant" class="block text-sm font-medium text-gray-700 mb-2">
                        Complainant
                    </label>
                    <input 
                        type="text" 
                ...
                <!-- Accused -->
                <div>
                    <label for="accused" class="block text-sm font-medium text-gray-700 mb-2">
                        Accused
                    </label>
                    <input 
                        type="text" 
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    <label for="investigating_officer" class="block text-sm font-medium text-gray-700 mb-2">
                        Investigating Officer
                    </label>
                    <input 
                        type="text" 
                ...
                <!-- Agency/Station -->
                <div>
                    <label for="agency_station" class="block text-sm font-medium text-gray-700 mb-2">
                        Agency/Station
                    </label>
                    <input 
                        type="text" 
                        id="agency_station" 
                        name="agency_station" 
                        value="{{ old('agency_station') }}"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500"
                        placeholder="Enter agency or station"
                    >
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <!-- Assigned Prosecutor -->
                <div>
                    <label for="prosecutor_id" class="block text-sm font-medium text-gray-700 mb-2">
                        Assigned Prosecutor
                    </label>
                    <select 
                        id="prosecutor_id" 
                ...
                <div>
                    ...
                    >
                        ...
                        <option value="{{ $status }}" {{ old('status', 'For Filing') == $status ? 'selected' : '' }}>{{ $status }}</option>
                        @endforeach
                    </select>
                    @error('status')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            <h3 class="text-lg font-semibold text-gray-900 mb-6 flex items-center">
                ...
                Hearing Details (Optional)
            </h3>
            
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <!-- Next Hearing -->
                <div>
                    <label for="next_hearing_at" class="block text-sm font-medium text-gray-700 mb-2">
                ...
                <!-- Court/Branch -->
                <div>
                    <label for="court_branch" class="block text-sm font-medium text-gray-700 mb-2">
                        Court/Branch
                    </label>
                    <input 
                        type="text" 
                        ...
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500"
                        placeholder="e.g., Branch 101 - Regional Trial Court"
                    >
                </div>
            </div>
        </div>
        ...
        <div class="flex items-center justify-end space-x-4">
            <a href="{{ route('cases.index') }}" class="px-6 py-2 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition-colors">
                Cancel
            </a>
